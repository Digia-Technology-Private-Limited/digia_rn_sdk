...
import { as$, JsonLike, tryKeys } from '../../framework/utils';
import { TextPropsClass, TextProps } from './text_props';

export class SliverAppBarProps {
    readonly title: TextPropsClass;
    ...
    static fromJson(json: JsonLike | null): SliverAppBarProps {
        return new SliverAppBarProps({
